...
//Name: Laptop_002_UV_001.ma
//Last modified: Mon, Aug 07, 2023 05:37:34 PM
//Codeset: 1252
requires maya "2023";
requires "mtoa" "5.1.2";
...
fileInfo "UUID" "0B31F1F0-4E62-8ADE-A266-C48A010DEA99";
createNode transform -s -n "persp";
	rename -uid "7DB14246-4186-3289-E114-3D9E2D8730FB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.8260491364077676 11.073925954462023 13.793134420188435 ;
	setAttr ".r" -type "double3" -34.538352728410629 12.199999999999143 -4.0675554542043016e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "29614DE1-4B1D-8DE4-5506-B9890FE271A2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 16.907382249998324;
...
connectAttr "polyTweakUV100.out" "pCubeShape89.i";
connectAttr "polyTweakUV100.uvtk[0]" "pCubeShape89.uvst[0].uvtw";
...
connectAttr "pCubeShape89.wm" "polyAutoProj91.mp";
