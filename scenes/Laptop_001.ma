...
//Name: Laptop_001.ma
//Last modified: Mon, Aug 07, 2023 12:02:20 PM
//Codeset: 1252
requires maya "2023";
requires "mtoa" "5.1.2";
...
fileInfo "UUID" "480088F0-4169-5949-1229-78828E8685B3";
createNode transform -s -n "persp";
	rename -uid "7DB14246-4186-3289-E114-3D9E2D8730FB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.45505171802724886 9.453814515969885 4.583621940203499 ;
	setAttr ".r" -type "double3" -56.13835272845909 -366.19999999956036 -3.9990841390330266e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "29614DE1-4B1D-8DE4-5506-B9890FE271A2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.581580562494814;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.49862781167030334 0.625 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 2 ".pt[28:29]" -type "float3"  2.910383e-11 2.3283064e-10 
		0 -2.910383e-11 -2.3283064e-10 0;
	setAttr ".dr" 1;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.334520508765772 0.49999995529651642 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mesh -n "pCubeShape3" -p "pCube3";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.33584464678535209 0.49999995529651642 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mesh -n "pCubeShape5" -p "pCube5";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.33552153331680845 0.49999995529651642 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mesh -n "pCubeShape7" -p "pCube7";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.33552153331680867 0.49999995529651642 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
createNode mesh -n "pCubeShape87" -p "pCube87";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.6146283745765686 0.625 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 9 ".pt";
	setAttr ".pt[20]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[21]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[22]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[23]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[24]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[25]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[26]" -type "float3" 0 -0.63936442 0 ;
	setAttr ".pt[27]" -type "float3" 0 -0.63936442 0 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "FC336331-4CD8-F219-EB81-BA90545EE071";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E482A7D7-476D-C8AF-04D7-C0A4CCD979D6";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "0FF936CF-449E-BAB0-847F-28B16B20B670";
createNode displayLayerManager -n "layerManager";
	rename -uid "381C324C-4600-EE7C-074B-EF8101CBE88E";
createNode displayLayer -n "defaultLayer";
	rename -uid "F170EE78-44C7-7D74-FB04-74AECAF83E21";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4C81A4DF-477D-3B4F-78D2-A0AB974AC310";
...
createNode polyTweak -n "polyTweak1";
	...
	setAttr ".uopa" yes;
	setAttr -s 4 ".tk";
	setAttr ".tk[10]" -type "float3" 0.011360506 0 0 ;
	setAttr ".tk[11]" -type "float3" 0.011360506 0 0 ;
...
createNode polyTweak -n "polyTweak3";
	...
	setAttr ".uopa" yes;
	setAttr -s 5 ".tk";
	setAttr ".tk[12]" -type "float3" 0.035822246 0 -0.080887087 ;
	setAttr ".tk[13]" -type "float3" -0.035822246 0 -0.080887087 ;
	setAttr ".tk[14]" -type "float3" -0.035822246 0 0.042067453 ;
	setAttr ".tk[15]" -type "float3" 0.035822246 0 0.042067453 ;
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "EF1FB915-4AD9-B201-A0D4-2FB95CE50589";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -622.61902287839041 -474.644354069695 ;
	setAttr ".tgi[0].vh" -type "double2" 1063.8670814606205 490.12054393091688 ;
...
createNode polyTweakUV -n "polyTweakUV1";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[12]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[13]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[14]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[15]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[20]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[21]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[22]" -type "float2" -0.28022707 0 ;
	setAttr ".uvtk[23]" -type "float2" -0.28022707 0 ;
...
createNode polyTweakUV -n "polyTweakUV2";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[12]" -type "float2" -0.27890292 0 ;
	setAttr ".uvtk[13]" -type "float2" -0.27890292 0 ;
	setAttr ".uvtk[14]" -type "float2" -0.27890292 0 ;
	setAttr ".uvtk[15]" -type "float2" -0.27890292 0 ;
	setAttr ".uvtk[20]" -type "float2" -0.27890292 0 ;
	setAttr ".uvtk[21]" -type "float2" -0.27890295 0 ;
	setAttr ".uvtk[22]" -type "float2" -0.27890295 0 ;
	setAttr ".uvtk[23]" -type "float2" -0.27890292 0 ;
...
createNode polyTweakUV -n "polyTweakUV3";
	...
	setAttr ".uopa" yes;
	setAttr -s 9 ".uvtk";
	setAttr ".uvtk[12]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[13]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[14]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[15]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[20]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[21]" -type "float2" -0.27922601 0 ;
	setAttr ".uvtk[22]" -type "float2" -0.27922601 0 ;
	setAttr ".uvtk[23]" -type "float2" -0.27922603 0 ;
...
createNode polyTweakUV -n "polyTweakUV5";
	...
	setAttr ".uvtk[15]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[20]" -type "float2" -0.27922603 0 ;
	setAttr ".uvtk[21]" -type "float2" -0.27922606 0 ;
	setAttr ".uvtk[22]" -type "float2" -0.27922606 0 ;
	setAttr ".uvtk[23]" -type "float2" -0.27922603 0 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "deleteComponent3.og" "pCubeShape88.i";
