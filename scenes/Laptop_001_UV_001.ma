...
//Name: Laptop_001_UV_001.ma
//Last modified: Mon, Aug 07, 2023 03:50:44 PM
//Codeset: 1252
requires maya "2023";
requires "mtoa" "5.1.2";
...
fileInfo "UUID" "41B79FDE-4B20-909C-148C-2185090E8E36";
createNode transform -s -n "persp";
	rename -uid "7DB14246-4186-3289-E114-3D9E2D8730FB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.7461481001128123 13.018587867400631 5.7102101722516991 ;
	setAttr ".r" -type "double3" -60.338352728307505 -362.59999999995802 1.9898951340789621e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "29614DE1-4B1D-8DE4-5506-B9890FE271A2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.556662243888809;
...
createNode mesh -n "pCubeShape88" -p "pCube88";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.1977308988571167 0.20088361948728561 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
...
connectAttr "polyMapCut9.out" "pCubeShape88.i";
