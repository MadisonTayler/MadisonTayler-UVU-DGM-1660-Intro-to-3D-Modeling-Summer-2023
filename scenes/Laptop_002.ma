...
//Name: Laptop_002.ma
//Last modified: Mon, Aug 07, 2023 05:30:02 PM
//Codeset: 1252
requires maya "2023";
requires "mtoa" "5.1.2";
...
fileInfo "UUID" "549B7AF5-4C77-AA2E-3E75-71B9E16A9B90";
createNode transform -s -n "persp";
	rename -uid "7DB14246-4186-3289-E114-3D9E2D8730FB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.17658590683604497 3.1184436352082492 8.8706369845666551 ;
	setAttr ".r" -type "double3" -6.338352728404467 -1.4000000000001558 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "29614DE1-4B1D-8DE4-5506-B9890FE271A2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 9.618689635798388;
...
createNode transform -n "pCylinder1";
	...
	setAttr ".t" -type "double3" -0.058995789122009423 4.8526326678139231 -1.396188681749517 ;
	setAttr ".r" -type "double3" 90 0 0 ;
...
createNode transform -n "pCylinder2";
	...
	setAttr ".t" -type "double3" -0.12181555764306647 4.8526326678139231 -1.3960628945524025 ;
	setAttr ".r" -type "double3" 90 0 0 ;
...
createNode mesh -n "pCubeShape89" -p "pCube90";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "54C2D151-444C-CC77-21DB-8A980789B9A8";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -622.61902287839052 -827.16754327048761 ;
	setAttr ".tgi[0].vh" -type "double2" 2285.9392310249241 836.69135241585491 ;
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyCube5.out" "pCubeShape89.i";
