...
//Name: Laptop_002_UV_001_Substance.ma
//Last modified: Mon, Aug 07, 2023 05:43:52 PM
//Codeset: 1252
requires maya "2023";
requires "mtoa" "5.1.2";
...
fileInfo "UUID" "70CBF9D8-4A64-3A9D-D159-E58FECB5870D";
createNode transform -s -n "persp";
	rename -uid "7DB14246-4186-3289-E114-3D9E2D8730FB";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.6095910377793303 7.9593302323938069 12.221117928399369 ;
	setAttr ".r" -type "double3" -23.13835272840981 7.8000000000002148 -2.0064103041282332e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "29614DE1-4B1D-8DE4-5506-B9890FE271A2";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.717918045188462;
...
createNode standardSurface -n "standardSurface3";
	rename -uid "A10F0B1B-4CEE-5E1E-52CE-24BA57DD4DAC";
...
createNode blinn -n "Camera";
	rename -uid "D657953D-4FB4-0CFD-32CD-A0BF8061F692";
...
createNode blinn -n "Light";
	rename -uid "8AA1C9DC-4EE5-0EBE-6A3F-988F03D68FFF";
...
createNode lambert -n "PowerButton";
	rename -uid "F715627D-44F6-4CD0-72AF-5FBE93533DF9";
...
createNode lambert -n "Mousepad";
	rename -uid "AFC52001-4818-9EC2-F970-46A3FA6A5AA3";
...
createNode blinn -n "Screen";
	rename -uid "54F06E8F-42AE-CF9B-8712-D391721D13AB";
...
createNode standardSurface -n "Keys";
	rename -uid "922D24D1-451E-E590-1623-36A27E5976AD";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "8FA42DC6-4091-D902-E990-73B9F26242B5";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" -622.61902287839064 -923.40430545543006 ;
	setAttr ".tgi[0].vh" -type "double2" 2620.3172784627141 931.73763845762676 ;
	setAttr -s 14 ".tgi[0].ni";
	setAttr ".tgi[0].ni[0].x" 734.28570556640625;
	setAttr ".tgi[0].ni[0].y" 330;
	setAttr ".tgi[0].ni[0].nvs" 2387;
	setAttr ".tgi[0].ni[1].x" 1082.857177734375;
	...
	setAttr ".tgi[0].ni[7].y" 771.4285888671875;
	setAttr ".tgi[0].ni[7].nvs" 1923;
	setAttr ".tgi[0].ni[8].x" 1061.4285888671875;
	...
	setAttr ".tgi[0].ni[11].x" 2000;
	setAttr ".tgi[0].ni[11].y" -375.71429443359375;
	setAttr ".tgi[0].ni[11].nvs" 1923;
	setAttr ".tgi[0].ni[12].x" 2010;
	setAttr ".tgi[0].ni[12].y" 182.85714721679688;
	setAttr ".tgi[0].ni[12].nvs" 1923;
	setAttr ".tgi[0].ni[13].x" 1702.857177734375;
...
connectAttr "LaptopBody.iog" "standardSurface3SG.dsm" -na;
connectAttr "pCubeShape91.iog" "standardSurface3SG.dsm" -na;
connectAttr "standardSurface3SG.msg" "materialInfo9.sg";
connectAttr "standardSurface3.msg" "materialInfo9.m";
connectAttr "standardSurface3.msg" "materialInfo9.t" -na;
connectAttr "Camera.oc" "blinn5SG.ss";
connectAttr "pCylinderShape1.iog" "blinn5SG.dsm" -na;
connectAttr "blinn5SG.msg" "materialInfo10.sg";
connectAttr "Camera.msg" "materialInfo10.m";
connectAttr "Light.oc" "blinn6SG.ss";
...
connectAttr "PowerButton.oc" "lambert5SG.ss";
connectAttr "pCylinderShape3.iog" "lambert5SG.dsm" -na;
connectAttr "lambert5SG.msg" "materialInfo12.sg";
connectAttr "PowerButton.msg" "materialInfo12.m";
connectAttr "Mousepad.oc" "lambert6SG.ss";
connectAttr "pCubeShape86.iog" "lambert6SG.dsm" -na;
connectAttr "lambert6SG.msg" "materialInfo13.sg";
connectAttr "Mousepad.msg" "materialInfo13.m";
connectAttr "Screen.oc" "blinn7SG.ss";
connectAttr "ComputerScreenObj.iog" "blinn7SG.dsm" -na;
connectAttr "blinn7SG.msg" "materialInfo14.sg";
connectAttr "Screen.msg" "materialInfo14.m";
connectAttr "Keys.oc" "standardSurface4SG.ss";
connectAttr "pCubeShape80.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape29.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape65.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape48.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape56.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape15.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape71.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape34.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape60.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape74.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape10.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape44.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape81.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape9.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape59.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape24.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape57.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape47.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape82.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape33.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape31.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape37.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape77.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape16.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape61.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape26.iog" "standardSurface4SG.dsm" -na;
...
connectAttr "pCubeShape35.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape49.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape73.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape8.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape78.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape39.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape62.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape36.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape50.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape79.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape17.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape12.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape21.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape46.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape76.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape64.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape53.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape38.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape84.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape7.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape45.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape3.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape19.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape85.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape55.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape27.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape41.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape18.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape11.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape51.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape30.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape54.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape43.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape13.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape69.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape63.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape20.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape75.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape58.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape52.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape32.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape25.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape70.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape22.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape4.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape83.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape42.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape23.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape66.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape68.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape14.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape72.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape2.iog" "standardSurface4SG.dsm" -na;
connectAttr "pCubeShape67.iog" "standardSurface4SG.dsm" -na;
connectAttr "standardSurface4SG.msg" "materialInfo15.sg";
connectAttr "Keys.msg" "materialInfo15.m";
connectAttr "Keys.msg" "materialInfo15.t" -na;
...
connectAttr "standardSurface3SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[1].dn"
		;
connectAttr "Keys.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[2].dn"
		;
connectAttr "standardSurface4SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[3].dn"
		;
connectAttr "Camera.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[4].dn"
		;
connectAttr "blinn5SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[5].dn"
		;
connectAttr "Mousepad.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[6].dn"
		;
connectAttr "PowerButton.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[7].dn"
		;
connectAttr "lambert5SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[8].dn"
		;
connectAttr "Screen.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[9].dn"
		;
connectAttr "lambert6SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[10].dn"
		;
connectAttr "blinn7SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[11].dn"
		;
connectAttr "blinn6SG.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[12].dn"
		;
connectAttr "Light.msg" "hyperShadePrimaryNodeEditorSavedTabsInfo.tgi[0].ni[13].dn"
		;
...
// End of Laptop_002_UV_001_Substance.ma
